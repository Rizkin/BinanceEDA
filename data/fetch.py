...
class BinanceOptionsFetcher(BinanceBaseFetcher):
    ...
    def __init__(self, api_key=BINANCE_API_KEY, api_secret=BINANCE_SECRET_KEY):
    ...
    def get_option_info(self, symbol):
        """
        Fetch information for a specific option pair.
        :param symbol: Option symbol (e.g., 'BTC-250328-90000-P').
        :return: Option info as a dictionary.
        """
        endpoint = f"{self.BASE_URL}/vapi/v1/optionInfo"
        try:
            return self._make_request("GET", endpoint, headers=self.headers, params={"symbol": symbol})
